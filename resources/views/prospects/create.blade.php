                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                        <div class="card-title">
                                            <h3 class="text-center">Add New Prospect</h3>
                                        </div>
                                        <hr>
                                        <form action="{{route('prospects.store')}}" method="post" name="prospectForm" id="prospectForm">
                                            {{ csrf_field() }}
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="fname" name="fname" type="text" class="form-control @if ($errors->has('fname')) is-invalid @endif" value="{{ old('fname') }}">
                                                        @if ($errors->has('fname'))
                                                ...
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="lname" name="lname" type="text" class="form-control @if ($errors->has('lname')) is-invalid @endif" value="{{ old('lname') }}">
                                                        @if ($errors->has('lname'))
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="city" name="city" type="text" class="form-control @if ($errors->has('city')) is-invalid @endif" value="{{ old('city') }}">
                                                        @if ($errors->has('city'))
