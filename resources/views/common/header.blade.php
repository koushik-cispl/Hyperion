        ...
        <div class="header-menu">
            <div class="header-left">
                ...
                <div class="dropdown for-message">
                    ...
                    <div class="dropdown-menu" aria-labelledby="message">
                        ...
                        <a class="dropdown-item media" href="#">
                            <span class="photo media-left"><img alt="avatar" src="{{asset('back_end/images/avatar/1.jpg')}}"></span>
                        ...
                        <a class="dropdown-item media" href="#">
                            <span class="photo media-left"><img alt="avatar" src="{{asset('back_end/images/avatar/2.jpg')}}"></span>
                            <div class="message media-body">
                        ...
                        <a class="dropdown-item media" href="#">
                            <span class="photo media-left"><img alt="avatar" src="{{asset('back_end/images/avatar/3.jpg')}}"></span>
                            <div class="message media-body">
                        ...
                        <a class="dropdown-item media" href="#">
                            <span class="photo media-left"><img alt="avatar" src="{{asset('back_end/images/avatar/4.jpg')}}"></span>
                            <div class="message media-body">
            ...
            <div class="user-area dropdown float-right">
                ...
                <div class="user-menu dropdown-menu">
                    <a class="nav-link" href="{{url('/admin/profile')}}"><i class="fa fa-user"></i>My Profiles</a>

                    <!-- <a class="nav-link" href="#"><i class="fa fa- user"></i>Notifications <span class="count">13</span></a>

                    <a class="nav-link" href="#"><i class="fa fa -cog"></i>Settings</a> -->
                    <a class="nav-link" href="{{url('/admin/change-password')}}"><i class="fa fa-lock"></i>Change Password</a>
