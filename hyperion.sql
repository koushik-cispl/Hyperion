...
--
-- Host: 127.0.0.1
-- Generation Time: May 17, 2019 at 11:24 AM
...
(1, 2, 'Koushik Kanjilal', 'koushik.kanjilal@codeclouds.in', '8583063630', 'Koushik_kanjilal1558011605.jpg', '$2y$10$Z.oPbjH4elvZjtPOHkkS3OulDvQNLAXpghsI6pgnHa2tETOV4zk96', 1, '2019-05-13 15:43:58', '2019-05-16 13:00:32'),
(2, 2, 'Ohed Ali', 'ohed.ali@codeclouds.in', '7410258963', 'unnamed1557495999.jpg', '$2y$10$jBS4WVVOa0DpAIPHDlXx8Osen0s2MIMv3OeczCgWeISKNd2JQTMmi', 1, '2019-05-10 13:46:39', '2019-05-10 13:46:39'),
(3, 1, 'Pritam Bhattacharya', 'pritam.bhattacharya@codeclouds.in', '8412985222', 'unnamed1558005816.jpg', '$2y$10$jBS4WVVOa0DpAIPHDlXx8Osen0s2MIMv3OeczCgWeISKNd2JQTMmi', 1, '2019-05-10 13:48:40', '2019-05-16 11:23:36'),
(4, 2, 'Tonmoy Saha', 'tonmoy.saha@codeclouds.in', '9632058741', 'sg1558005829.png', '$2y$10$d47z52US/xcIx5fk9J1XPevQm/065ardWrf1ZsKGTZBvxY7eTlD9a', 1, '2019-05-14 07:35:26', '2019-05-16 11:23:49');
...
--
-- Table structure for table `crm_configurations`
--

CREATE TABLE `crm_configurations` (
  `id` int(11) NOT NULL,
  `api_name` varchar(55) DEFAULT NULL,
...
--
-- Dumping data for table `crm_configurations`
--

INSERT INTO `crm_configurations` (`id`, `api_name`, `api_endpoint`, `api_username`, `api_password`, `created_at`, `updated_at`) VALUES
(1, 'LL', 'greenvalley.limelightcrm.com', 'codecloudsApi', 't8gtJb9HwGUqw', '2019-05-10 10:07:35', '2019-05-14 13:41:03');
...
INSERT INTO `prospects` (`id`, `fname`, `lname`, `email`, `mobile`, `address`, `country`, `state`, `city`, `zip_code`, `campaign_id`, `status`, `order_place_status`, `created_by`, `created_at`, `updated_at`) VALUES
(1, 'test', 'test', 'test9@codeclouds.com', '9887415333', 'demos', 101, 4, 'test', '85320', NULL, 1, 0, 1, '2019-05-14 11:13:40', '2019-05-14 12:32:40'),
(2, 'demo', 'demo', 'koushik.kanjilal@codeclouds.in', '8583063630', 'testing', 28, 496, 'testings', '96385', NULL, 1, 0, 1, '2019-05-15 11:03:05', '2019-05-15 11:03:05');
...
(3, 'Customer Support', 1, '2019-05-16 03:10:07', '2019-05-16 05:10:11');
...
--
-- Table structure for table `uploaded_csvs`
--
...
--
-- Indexes for table `crm_configurations`
--
...
--
-- Indexes for table `uploaded_csvs`
--
ALTER TABLE `uploaded_csvs`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT for table `crm_configurations`
--
ALTER TABLE `crm_configurations`
...
--
-- AUTO_INCREMENT for table `uploaded_csvs`
--
ALTER TABLE `uploaded_csvs`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `prospects`
  ADD CONSTRAINT `country_id` FOREIGN KEY (`country`) REFERENCES `countries` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION,
  ADD CONSTRAINT `state_id` FOREIGN KEY (`state`) REFERENCES `states` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION,
...
--
ALTER TABLE `states`
  ADD CONSTRAINT `countryId` FOREIGN KEY (`country_id`) REFERENCES `countries` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION;

--
-- Constraints for table `uploaded_csvs`
--
ALTER TABLE `uploaded_csvs`
